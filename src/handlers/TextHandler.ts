...
import type { FileInfo, TextExtractionResult, TextMetadata, TextQuality } from '@/types';
...
export class TextHandler {
    ...
    public async extractText(fileInfo: FileInfo): Promise<TextExtractionResult> {
        const textLogger = this.logger.getTextExtractionLogger(LOG_COMPONENTS.FILE_HANDLER);
