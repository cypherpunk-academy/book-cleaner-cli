...
export class Step1_6ExecutionSummary implements PipelineStepResult {
        ...
        this.logger.info(
            {
                ...
                errorsCorreted:
                    finalSummary.enhancementResults?.ocrErrorsCorrected || 0,
                accuracyImprovement:
     ...
     */
    updateInputMetrics(
        metrics: Partial<OCRQualityEnhancementSummary['inputMetrics']>,
    ): void {
     ...
     */
    updateOutputMetrics(
        metrics: Partial<OCRQualityEnhancementSummary['outputMetrics']>,
    ): void {
