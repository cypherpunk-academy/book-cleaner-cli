...
export class Step1_5ExecutionSummary implements PipelineStepResult {
        ...
        this.logger.info(
            {
                ...
                footnotesConverted:
                    finalSummary.conversionResults?.footnotesConverted || 0,
            },
     ...
     */
    updateInputMetrics(
        metrics: Partial<FootnoteConversionSummary['inputMetrics']>,
    ): void {
     ...
     */
    updateOutputMetrics(
        metrics: Partial<FootnoteConversionSummary['outputMetrics']>,
    ): void {
