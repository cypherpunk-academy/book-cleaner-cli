...
export class DataLoadingPhase extends AbstractPhase {
    ...
    public override async execute(
        ...
        try {
            ...
            const fileInfo: FileInfo = {
                ...
                size: stats.size,
                format: path.extname(state.inputFile).toLowerCase().slice(1) as FileInfo['format'],
            ...
            let enhancedTextResult:
                | import('./phase_1_Text_Extraction_And_Format_Processing/step_3_Text_Auto_Correction/TextEnhancer').TextPreprocessingResult
                | null = null;
     ...
     */
    private getConfigKey(metadata: { author: string; title: string; bookIndex?: string }): string {
